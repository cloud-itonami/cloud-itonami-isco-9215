...
This project handles forestry-site operating workflows. Treat
...
risk (falling-tree/branch hazard: struck-by injury) and outdoor
exposure/terrain risk (weather, uneven terrain, equipment condition).
...
- ForestrySiteGovernor bypass
- audit-ledger tampering
- over-disclosure in reports or exports
- unsafe robot action dispatch
- any path that lets a proposal reach a forestry-work-execution
  decision, a site-safety-clearance decision (e.g. declaring a site
  cleared for safety), or a site-safety-supervisor override decision
