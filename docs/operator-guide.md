...
1. Define the operator's forestry-site coverage and crew intake process.
...
- safety-critical escalation path (falling-tree/branch hazard,
  uneven-terrain hazard, equipment-condition hazard, weather exposure)
- provenance for all operating records (worker and site both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a forestry-work-
  execution decision, a site-safety-clearance decision (e.g. declaring a
  site cleared for safety), or a site-safety-supervisor override
...
humans, and that no deployment configuration can route a forestry-work-
